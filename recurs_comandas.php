...
<head>
    <meta charset="UTF-8">
    <title>Mis Compras - Sabores de Galicia</title>
    ...
    <link rel="stylesheet" type="text/css" href="/styles/style_comandas.css">
    ...
    <style>
        .menu a[href="index.php?accio=mostra-comandas"]{
...
<section id="contingutCabas">
    <?php require __DIR__.'/controladores/c_mostraComandas.php'; ?>
</section>
<footer>
